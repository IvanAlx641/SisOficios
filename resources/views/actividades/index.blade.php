    ...
    <style>
        ...
        @media (max-width: 767.98px) {
            .btn-nuevo-responsive {
                ...
                width: auto !important; /* Para que no se estire raro en móviles */
            }
        }
    </style>
                        ...
                        <div class="col-12 d-flex flex-column flex-md-row align-items-md-center gap-2 gap-md-3">
                            ...
                            <div class="d-flex w-100 w-md-auto" style="overflow-x: auto; padding-bottom: 2px;">
                                <div class="btn-group shadow-sm flex-nowrap" role="group">
                                    ...
                                    <label class="btn btn-outline-secondary btn-sm px-3 py-2 text-nowrap" for="estTodas">Todos</label>
                                    ...
                                    <label class="btn btn-outline-warning btn-sm px-3 py-2 text-nowrap"
                                    ...
                                    <label class="btn btn-outline-success btn-sm px-3 py-2 text-nowrap" for="estAtendida">Atendidas</label>
                                </div>
                            </div>
                        </div>
                    </div>
