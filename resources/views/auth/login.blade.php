...
<head>
    ...
    <style>
        :root {
            --guinda: #9D2449;       /* Color Primario */
            --guinda-oscuro: #811e3c;
            --dorado: #C09F62;       /* Color Secundario */
            --gris-bg: #F8F9FA;
        }

        body, html { height: 100%; margin: 0; font-family: 'Segoe UI', sans-serif; background: white; }
        ...
        .footer-icons-bar {
            ...
            gap: 2rem;
            border-top: 5px solid var(--dorado); /* La línea dorada superior */
            z-index: 10;
        }
        ...
        /* Inputs */
        .form-label { color: #666; font-size: 0.9rem; margin-bottom: 5px; margin-left: 2px; }
        ...
        .forgot-link:hover { text-decoration: underline; color: var(--dorado); }
    ...
    <div class="row g-0">
        ...
        <div class="col-lg-4 login-form-wrapper">
            <div class="login-card">
                ...
                <img src="{{ asset('materialpro/assets/images/morenaicons/pleca.png') }}" 
                    alt="Separador" class="img-pleca">

                @if ($errors->any())
                    <div class="alert alert-danger border-0 bg-danger-subtle text-danger py-2 mb-3 rounded-3">
                        <i class="ti ti-alert-circle me-1"></i> <small>{{ $errors->first() }}</small>
                    </div>
                @endif
                ...
                <form action="{{ route('login.post') }}" method="POST">
                    ...
                    <div class="mt-4">
                        ...
                        <a href="{{ route('password.request') }}" class="forgot-link fw-bold mt-1">Recupérala aquí.</a>
                    </div>
                </form>
