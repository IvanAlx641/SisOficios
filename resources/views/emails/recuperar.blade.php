...
<head>
    <style>
        ...
        .header h1 { color: #ffffff; margin: 0; font-size: 22px; font-weight: normal; }
        ...
        .btn:hover { background-color: #9D2449; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Solicitud para restablecer la contraseña de tu cuenta <strong>{{ $email }}</strong>.</p>
