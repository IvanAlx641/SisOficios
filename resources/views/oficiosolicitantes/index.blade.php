...
<div class="card border-0 shadow-sm rounded-3">
    ...
    <div class="card-body p-4 bg-light">
        ...
        <div class="d-flex justify-content-end mb-4">
            <button type="button" class="btn btn-guinda rounded-pill px-4 shadow-sm" data-bs-toggle="modal" data-bs-target="#addSolicitanteModal">
                Agregar
            </button>
        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body">
                            ...
                            <p class="fw-semibold small text-dark mb-2 text-truncate">{{ $solicitante->dependencia->nombre_dependencia ?? 'N/A' }}</p>
                            
                            <p class="small text-muted mb-1">Cargo</p>
                            <p class="fw-semibold small text-dark mb-0 text-truncate">{{ $solicitante->cargo }}</p>
                            
                            <div class="mt-3 text-end">
                                <form action="{{ route('oficiosolicitante.destroy', $solicitante->id) }}" method="POST">
                                    @csrf @method('DELETE')
        ...
        <div class="mt-5 pt-3 border-top">
            <a href="{{ route('oficio.index') }}" class="btn-cancelar">Salir</a>
        </div>
    </div>
</div>
